...
const { ensureOwnerTypeColumns, ensureScheduleTemplateTables, ensurePlanLevelColumn, ensureLeadBidStatusColumn, ensureUserTimezoneColumn, ensureSubscriptionReverifyColumn, ensureReverifyEmailLogTable, ensureJobColorColumn, ensureAppointmentAllDayColumn, dropUserMobileUniqueIndex, ensureUserAccountSourceColumn, ensureUserFirstLoginColumn, ensureUserLevelColumn, ensureFamilyFriendSubcategory, ensureSubscriptionPaymentColumns, ensurePaymentReceiptsTable, ensureTaskManagerColumns, ensureTaskAssigneesTable } = require("./services/dbMigrations");
    ...
    while (retries > 0) {
        ...
        if (dbConnected) {
            ...
            try {
                ...
                await ensureUserFirstLoginColumn(migrationConn);
                await ensureUserLevelColumn(migrationConn);
                await ensureFamilyFriendSubcategory(migrationConn);
                await ensureSubscriptionPaymentColumns(migrationConn);
