...
router.get("/lineitems", auth.authenticateToken, requireJobBudgetFeature, async (req, res) => {
...
router.post("/contingency", auth.authenticateToken, requireJobBudgetFeature, async (req, res) => {
...
router.get("/divisions/:divisionId/lineitems", auth.authenticateToken, requireJobBudgetFeature, async (req, res) => {
...
router.post("/divisions/:divisionId/lineitems", auth.authenticateToken, requireJobBudgetFeature, async (req, res) => {
  const { divisionId } = req.params;
...
router.delete("/divisions/:divisionId/lineitems/:itemId", auth.authenticateToken, requireJobBudgetFeature, async (req, res) => {
